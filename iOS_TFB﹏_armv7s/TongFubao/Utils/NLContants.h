...
#define TFBVersion @"3.3.0"//版本号 外包的方式

#define TFBbundilVersion [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"] 
...
#define NAV_AGENTCOLOR [UIColor colorWithRed:0/255.0 green:103/255.0 blue:153/255.0 alpha:1.0] /*tab背景色*/

//#define NAV_COLOR [UIColor colorWithRed:0.0/255.0 green:181.0/255.0 blue:232.0/255.0 alpha:1.0]
