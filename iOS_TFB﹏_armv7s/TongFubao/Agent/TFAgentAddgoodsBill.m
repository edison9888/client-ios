...
-(void)UIInit
{
    ...
    //刷卡
    UIImageView *inputView = [[UIImageView alloc]initWithFrame:CGRectMake(10, 261+IOS7HEIGHT, 300, 45)];
    ...
    inputLabelText.text = @"sss";
    inputLabelText.font = [UIFont systemFontOfSize:14];
    [inputView addSubview:inputLabelText];
     */
    
    _inputTextField = [[UITextField alloc]initWithFrame:CGRectMake(10, 2.5, 250, 40)];
    ...
    _inputImg = [[UIImageView alloc]initWithFrame:CGRectMake(260, 7.5, 30, 30)];
