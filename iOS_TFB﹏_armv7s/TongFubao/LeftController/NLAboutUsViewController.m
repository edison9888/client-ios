...
- (void)viewDidLoad
{
    ...
    self.navigationController.topViewController.title=@"关于通付宝公司";
...
-(void)initValue
{
    self.myVersionLabel.text = [NSString stringWithFormat:@"%@",TFBVersion];
}
    ...
    switch (section)
    {
        case 0:
        {
            switch (row)
            {
                ...
                case 2:
                {
                    NSURL *URL = [NSURL URLWithString:@"http://www.tfbpay.cn/mobilepay/wechat.php"];
