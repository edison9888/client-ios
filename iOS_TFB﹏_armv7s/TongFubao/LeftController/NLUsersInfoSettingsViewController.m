...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section)
    {
        case 0:
        {
            ...
            [cell.myDownrightBtn setFrame:CGRectMake(120, 15, 60, 60)];
            cell.myDownrightBtn.hidden = NO;
            cell.myDownrightImage.hidden = NO;
            [cell.myDownrightImage setFrame:CGRectMake(120, 15, 60, 60)];
...
//                _downImage = cell.myDownrightImage.image;
            ...
            [cell.myUprightBtn setFrame:CGRectMake(200, 15, 60, 60)];
            cell.myUprightBtn.hidden = NO;
            cell.myUprightImage.hidden = NO;
            [cell.myUprightImage setFrame:CGRectMake(200, 15, 60, 60)];
            if (_upImage)
            {
