...
@synthesize tripTicketTableView,leftTicket,rigthTicket,PaiXuaAllArray,temporaryPaiXuaAllArray,CityKey,tapGesture;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        // 视图
        self.tripTicketTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height-STATABLEHIETH)];
        self.tripTicketTableView.delegate = self;
        self.tripTicketTableView.dataSource = self;
        [self addSubview:self.tripTicketTableView];
        self.tapGesture=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(tapAction)];
        self.tapGesture.numberOfTapsRequired = 1;
        self.tapGesture.enabled = NO;
        [self.tripTicketTableView addGestureRecognizer:self.tapGesture];
        //向左向右都可以
        ...
        [self.tripTicketTableView addGestureRecognizer:Leftswipe];
        UISwipeGestureRecognizer *Rightswipe=[[UISwipeGestureRecognizer alloc]initWithTarget:self action:@selector(RightSwipeAction)];
        Rightswipe.direction=UISwipeGestureRecognizerDirectionRight;
        [self.tripTicketTableView addGestureRecognizer:Rightswipe];
...
//    NSLog(@"========%@=====%@======",newrigthTicket,newrigthTicketCode);
    ...
    [self.tripTicketTableView reloadData];
}
// 没有数据时清除内存
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.delegata TripTicketViewAirLineInfoArray:airLineInfoArray];
}
