...
@interface QcoinMoneyGive : UIViewController<UPPayPluginDelegate,VisaReaderDelegate,NLBankLisDelegate,UITextFieldDelegate,BankPayListDelegate,UIAlertViewDelegate>
