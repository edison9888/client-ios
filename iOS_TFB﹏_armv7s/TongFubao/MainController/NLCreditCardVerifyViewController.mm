...
-(void)createInforForResultView:(NLTransferResultViewController*)vc
{
    ...
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"还款金额",@"header", [NSString stringWithFormat:@"%@元",[self.myDictionary objectForKey:@"paymoney"]],@"content", nil];
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"手续费用",@"header", [NSString stringWithFormat:@"%@元",[self.myDictionary objectForKey:@"feemoney"]],@"content", nil];
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"总金额",@"header", [NSString stringWithFormat:@"%@元",[self.myDictionary objectForKey:@"allmoney"]],@"content", nil];
    [arr addObject:dic];
