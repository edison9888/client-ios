...
-(void)createInforForResultView:(NLTransferResultViewController*)vc index:(int)index
{
    ...
    NSDictionary* dic = [NSDictionary dictionaryWithObjectsAndKeys:@"交易流水号",@"header", [dictionary objectForKey:@"accglistno"],@"content", nil];
    [arr addObject:dic];
    ...
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"交易总计",@"header", [NSString stringWithFormat:@"%@元",[dictionary objectForKey:@"accglistmoney"]],@"content", nil];
    [arr addObject:dic];
