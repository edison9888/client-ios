...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.myUprightImage.image = [UIImage imageNamed:[[self.myArray objectAtIndex:indexPath.row] objectForKey:@"com"]];
    if (cell.myUprightImage.image==nil) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    vc.iconNameStr= [[self.myArray objectAtIndex:indexPath.row] objectForKey:@"com"];
    NSString *apptxt = [[self.myArray objectAtIndex:indexPath.row] objectForKey:@"phonetxt"];
    if (apptxt!=nil) {
