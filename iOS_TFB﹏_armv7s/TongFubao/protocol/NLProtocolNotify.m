...
/*易宝商户验证码*/
- (void)ApicouponPaySMSverifyNotify:(NSNotification *)notify;
//手续费计算
- (void)ApigetcreditCardMoneyPayfeeNotify:(NSNotification *)notify;
//信用卡还款请求
- (void)ApicreditCardMoneyRqNotify:(NSNotification *)notify;
//信用卡还款短信验证码验证返回
- (void)ApicreditCardMoneySMSverifyNotify:(NSNotification *)notify;
//刷卡器刷卡管理
- (void)ApipayCardCheckNotify:(NSNotification *)notify;

//易宝Q币充值
- (void)ApiqqrechargeReqNotify:(NSNotification *)notify;
//易宝QQ币充值短信验证码验证返回
- (void)ApiqqrechargeSMSverifyNotify:(NSNotification *)notify;
...
/*汇通宝-商户收款（抵用券）*/
-(void)ApiExpresspayInfoNotify:(NSNotification *)notify;
/*汇通宝-商户收款（抵用券）交易状态显示*/
-(void)ApiExpresspayInfoToPayNotify:(NSNotification *)notify;
...
// 生成订单
- (void)ApiGetCreateOrderNotify:(NSNotification *)notify;
// 查询订单
- (void)ApiGetOrderHistoryNotify:(NSNotification *)notify;
// 验证码
- (void)ApiGetpayWithCreditCardNotify:(NSNotification *)notify;
...
/*酒店*/
//获取城市
- (void)ApiHotelGetCityNotify:(NSNotification *)notify;
//获取商业区/行政区
- (void)ApiHotelGetDistrictNotify:(NSNotification *)notify;
/*119 pay people history */
- (void)ApireadwagelistsNotify:(NSNotification *)notify;
...
-(void)addNotify:(NLProtocolRequestType)type
{
    switch (type)
    {
        ...
        case NLProtocolRequest_ApigetAirline:
            ...
            break;
            /*查询详情*/
        case NLProtocolRequest_GetAirlineDetail:
            REGISTER_NOTIFY_OBSERVER(self,ApigetAirlineDetailNotify, Notify_GetAirlineDetail);
            break;
            /*添加乘机人*/
        ...
        case NLProtocolRequest_deletePassenger:
            ...
            break;
            /*生成订单*/
        case NLProtocolRequest_createOrder:
            REGISTER_NOTIFY_OBSERVER(self,ApiGetCreateOrderNotify, Notify_createOrder);
            break;
            
            /*查询订单*/
        case NLProtocolRequest_OrderHistory:
            REGISTER_NOTIFY_OBSERVER(self,ApiGetOrderHistoryNotify, Notify_getOrderHistory);
            break;
            
            /*验证码*/
        case NLProtocolRequest_payWithCreditCard:
            REGISTER_NOTIFY_OBSERVER(self,ApiGetpayWithCreditCardNotify, Notify_getpayWithCreditCard);
            break;
        ...
        case NLProtocolRequest_ApiGamePayWithVerifyCode:
            ...
            break;
            /*易宝商户收款*/
        case NLProtocolRequest_ApicouponPayReq:
            REGISTER_NOTIFY_OBSERVER(self, ApicouponPayReqNotify, Notify_ApicouponPayReq);
            break;
            /*易宝商户验证码*/
        case NLProtocolRequest_ApicouponPaySMSverify:
            REGISTER_NOTIFY_OBSERVER(self, ApicouponPaySMSverifyNotify, Notify_ApicouponPaySMSverify);
            break;
            //手续费计算
        case NLProtocolRequest_ApigetcreditCardMoneyPayfee:
            REGISTER_NOTIFY_OBSERVER(self, ApigetcreditCardMoneyPayfeeNotify, Notify_ApigetcreditCardMoneyPayfee);
            break;
            //信用卡还款请求
        case NLProtocolRequest_ApicreditCardMoneyRq:
            REGISTER_NOTIFY_OBSERVER(self, ApicreditCardMoneyRqNotify, Notify_ApicreditCardMoneyRq);
            break;
            //信用卡还款短信验证码验证返回
        case NLProtocolRequest_ApicreditCardMoneySMSverify:
            REGISTER_NOTIFY_OBSERVER(self, ApicreditCardMoneySMSverifyNotify, Notify_ApicreditCardMoneySMSverify);
            break;
            //刷卡器刷卡管理
        case NLProtocolRequest_ApipayCardCheck:
            REGISTER_NOTIFY_OBSERVER(self, ApipayCardCheckNotify, Notify_ApipayCardCheck);
            break;
            //易宝Q币充值
        case NLProtocolRequest_ApiqqrechargeReq:
            REGISTER_NOTIFY_OBSERVER(self, ApiqqrechargeReqNotify, Notify_ApiqqrechargeReq);
            break;
            //易宝QQ币充值短信验证码验证返回
        case NLProtocolRequest_ApiqqrechargeSMSverify:
            REGISTER_NOTIFY_OBSERVER(self, ApiqqrechargeSMSverifyNotify, Notify_ApiqqrechargeSMSverify);
            break;
            /*话费是否可以充值*/
        ...
        case NLProtocolRequest_ApiPaychannelInfo:
            ...
            break;
             /*汇通宝-商户收款（抵用券）*/
        case NLProtocolRequest_ApiExpresspayInfo:
            REGISTER_NOTIFY_OBSERVER(self, ApiExpresspayInfoNotify, Notify_ApiExpresspayInfo);
            break;
            /*酒店*/
            //获取城市
        case NLProtocolRequest_ApiHotelGetCity:
            REGISTER_NOTIFY_OBSERVER(self, ApiHotelGetCityNotify, Notify_ApiHotelGetCity);
            break;
            /*汇通宝-商户收款（抵用券）交易状态显示*/
        case NLProtocolRequest_ApiExpresspayInfoToPay:
            REGISTER_NOTIFY_OBSERVER(self, ApiExpresspayInfoToPayNotify, Notify_ApiExpresspayInfoToPay);
            break;
            //获取商业区/行政区
        case NLProtocolRequest_ApiHotelGetDistrict:
            REGISTER_NOTIFY_OBSERVER(self, ApiHotelGetDistrictNotify, Notify_ApiHotelGetDistrict);
            break;
            /*119 people pay history*/
        case NLProtocolRequest_Apireadwagelists:
            REGISTER_NOTIFY_OBSERVER(self, ApireadwagelistsNotify, Notify_Apireadwagelists);
            break;
...
-(void)removeNotify:(NLProtocolRequestType)type
{
    switch (type)
    {
        ...
        case NLProtocolRequest_ApigetAirline:
            ...
            /*航班详情*/
//        case NLProtocolRequest_GetAirlineDetail:
//            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_GetAirlineDetail);
//            break;
            /*添加登机人*/
        case NLProtocolRequest_SavePassenger:
        ...
        case NLProtocolRequest_deletePassenger:
            ...
            /*飞机票生成订单*/
        case NLProtocolRequest_createOrder:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_createOrder);
            break;
            /*飞机票查询订单*/
        case NLProtocolRequest_OrderHistory:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_getOrderHistory);
            break;
            /*验证码*/
        case NLProtocolRequest_payWithCreditCard:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_getpayWithCreditCard);
            break;
        ...
        case NLProtocolRequest_ApiGamePayWithVerifyCode:
            ...
            /*易宝商户收款*/
        case NLProtocolRequest_ApicouponPayReq:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApicouponPayReq);
            break;
            /*易宝商户验证码*/
        case NLProtocolRequest_ApicouponPaySMSverify:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApicouponPaySMSverify);
            break;
            //手续费计算
        case NLProtocolRequest_ApigetcreditCardMoneyPayfee:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApigetcreditCardMoneyPayfee);
            break;
            //信用卡还款请求
        case NLProtocolRequest_ApicreditCardMoneyRq:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApicreditCardMoneyRq);
            break;
            //信用卡还款短信验证码验证返回
        case NLProtocolRequest_ApicreditCardMoneySMSverify:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApicreditCardMoneySMSverify);
            break;
            //刷卡器刷卡管理
        case NLProtocolRequest_ApipayCardCheck:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApipayCardCheck);
            break;
            //易宝Q币充值
        case NLProtocolRequest_ApiqqrechargeReq:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiqqrechargeReq);
            break;
            //易宝QQ币充值短信验证码验证返回
        case NLProtocolRequest_ApiqqrechargeSMSverify:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiqqrechargeSMSverify);
            break;
            /*话费是否可以充值*/
        case NLProtocolRequest_ApiCanRecharge:
        ...
        case NLProtocolRequest_ApiPaychannelInfo:
            ...
            /*汇通宝-商户收款（抵用券）*/
        case NLProtocolRequest_ApiExpresspayInfo:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiExpresspayInfo);
            break;
            /*汇通宝-商户收款（抵用券）交易状态显示*/
        case NLProtocolRequest_ApiExpresspayInfoToPay:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiExpresspayInfoToPay);
            break;
            /*酒店*/
            //获取城市
        case NLProtocolRequest_ApiHotelGetCity:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiHotelGetCity);
            break;
            //获取商业区/行政区
        case NLProtocolRequest_ApiHotelGetDistrict:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_ApiHotelGetDistrict);
            break;
            /*119 people pay history*/
        case NLProtocolRequest_Apireadwagelists:
            REMOVE_NOTIFY_OBSERVER_FOR_NAME(self, Notify_Apireadwagelists);
            break;
        default:
            break;
    }
...
- (void)ApicouponPayReqNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApicouponPayReq response:response];
        return ;
    }
...
- (void)ApicouponPaySMSverifyNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApicouponPaySMSverify response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApicouponPaySMSverify response:response];
}
...
- (void)ApigetcreditCardMoneyPayfeeNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApigetcreditCardMoneyPayfee response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApigetcreditCardMoneyPayfee response:response];
}
...
- (void)ApicreditCardMoneyRqNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApicreditCardMoneyRq response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApicreditCardMoneyRq response:response];
}
...
- (void)ApicreditCardMoneySMSverifyNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApicreditCardMoneySMSverify response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApicreditCardMoneySMSverify response:response];
}
...
- (void)ApipayCardCheckNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApipayCardCheck response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApipayCardCheck response:response];
}
...
- (void)ApiqqrechargeReqNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiqqrechargeReq response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApiqqrechargeReq response:response];
}
...
- (void)ApiqqrechargeSMSverifyNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiqqrechargeSMSverify response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApiqqrechargeSMSverify response:response];
}
...
- (void)ApiExpresspayInfoNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiExpresspayInfo response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApiExpresspayInfo response:response];
}
...
- (void)ApigetAirlineDetailNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_GetAirlineDetail response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_GetAirlineDetail response:response];
}
...
- (void)ApiGetDeletePassengerNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_deletePassenger response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_deletePassenger response:response];
...
- (void)ApiGetCreateOrderNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_createOrder response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_createOrder response:response];
}
...
- (void)ApiGetOrderHistoryNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_OrderHistory response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_OrderHistory response:response];
...
- (void)ApiGetpayWithCreditCardNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_payWithCreditCard response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_payWithCreditCard response:response];
...
-(void)ApiExpresspayInfoToPayNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiExpresspayInfoToPay response:response];
        return ;
    }
    [self doDefaultEnd:NLProtocolRequest_ApiExpresspayInfoToPay response:response];
}
...
- (void)ApiHotelGetCityNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiHotelGetCity response:response];
        return ;
    }
...
- (void)ApiHotelGetDistrictNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_ApiHotelGetDistrict response:response];
        return ;
    }
...
- (void)ApireadwagelistsNotify:(NSNotification *)notify
{
    ...
    if (errorCode != RSP_NO_ERROR)
    {
        [self doDefaultEnd:NLProtocolRequest_Apireadwagelists response:response];
        return ;
    }
