...
- (id)initWithSectionIndexes:(BOOL)showSectionIndexes resourcePath:(NSString*)path
{
...
{
    //NSPredicate *predicateString = [NSPredicate predicateWithFormat:@"contains[cd] %@", searchString];
     //NSMutableArray  *filteredArray = [NSMutableArray arrayWithArray:[_dataHold filteredArrayUsingPredicate:predicateString]];
    self.filteredPersons = [self.filteredPersons filteredArrayUsingPredicate:[NSPredicate predicateWithFormat:@"name contains[cd] %@", searchString]];
