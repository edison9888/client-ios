...
//        self.backgroundColor = RGBACOLOR(19, 193, 245, 0.1);
        ...
        IphnoeLabel.textColor = [UIColor whiteColor];
        ...
        [deleButton setImage:[UIImage imageNamed:@"delete@2x.png"] forState:(UIControlStateNormal)];
...
-(void)deleButton:(UIButton *)sender
{
    if (sender.selected == YES) {
        [sender setImage:[UIImage imageNamed:@"delete2@2x.png"] forState:(UIControlStateNormal)];
        sender.selected = NO;
    }
    else
    {
    ...
    [self.delegate deletSelectionButtonTag:sender.tag];
