...
@synthesize PassengerName,PassengerCardType,PassengerCardId,PassengerPersonIphone,selectionPersonIphone;
...
-(void)rightItemClick:(id)sender
{
    ...
    NSLog(@"=====PassengerCardType====%@",self.PassengerCardType);
    if ([self.PassengerName length] >0 && [self.PassengerCardId length] > 0 && [self.PassengerCardType length] > 0)
    {
        ...
        [[[NLProtocolRequest alloc]initWithRegister:YES]savePassengerName:self.PassengerName savePassengerCardType:self.PassengerCardType savePassengerCardId:self.PassengerCardId savePassengerPhoneNumber:@"" savePassengerPassengerType:[NSString stringWithFormat:@"%d",self.PassengerType]];
    }
    else
    {
