...
- (id)init {
    self.backgroundColor = RGBACOLOR(3, 198, 230, 1);
...
//    [self setDayOfWeekTextColor:UIColorFromRGB(0x999999)];
    [self setDayOfWeekTextColor:RGBACOLOR(3, 198, 230, 1)];
...
//    [self setDateBackgroundColor:UIColorFromRGB(0xF2F2F2)];
    [self setDateBackgroundColor:RGBACOLOR(3, 198, 230, 1)];
...
//    [self setSelectedDateBackgroundColor:UIColorFromRGB(0x88B6DB)];
    [self setSelectedDateBackgroundColor:RGBACOLOR(3, 198, 230, 1)];
