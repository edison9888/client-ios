...
- (void)initView
{
    ...
    if (currentType == ImpowerInfoType)
    {
        ...
        for (int i = 0; i < 2; i++)
        {
            ...
            infoText[i].text = (i == 0? (self.impowerNumber? self.impowerNumber : @"") : @"未绑定");
                           ...
                           unSelectImage:[UIImage imageNamed:@"change_btn_normal@2x"]
                             selectImage:nil
                              ...
                              titleColor:[UIColor whiteColor]
                                   title:(currentType == ImpowerInfoType? @"绑定本机" : currentType == ImpowerSignOutType? @"确定" : @"获取授权码")];
...
{
    NSString *string = [SvUDIDTools UDID];
