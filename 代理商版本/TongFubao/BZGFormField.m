...
#define DEFAULT_LEFT_TEXT_PADDING 0.95
#define DEFAULT_LEFT_INDICATOR_INACTIVE_ASPECT_RATIO 0.95
#define DEFAULT_LEFT_INDICATOR_ACTIVE_ASPECT_RATIO 1
...
- (void)setup
{
    ...
    self.leftIndicatorNoneColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"gray@2x.png"]];
    
    self.leftIndicatorValidColor  = [UIColor colorWithPatternImage: [UIImage imageNamed:@"lockblue2@2x.png"]];
    
    self.leftIndicatorInvalidColor = [UIColor colorWithPatternImage: [UIImage imageNamed:@"yellow.png"]];
    
//    self.leftIndicatorInactiveWidth= 35;
                        ...
                        animated:(BOOL)animated
{
    ...
    switch (formFieldState) {
        case BZGFormFieldStateNone:
             self.leftIndicator.layer.contents = (__bridge  id) [UIImage imageNamed:@"gray@2x.png"].CGImage;
            [self.leftIndicator setTitle:@"" forState:UIControlStateNormal];
            break;
        case BZGFormFieldStateInvalid:
            self.leftIndicator.layer.contents = (__bridge  id) [UIImage imageNamed:@"yellow.png"].CGImage;
            break;
        case BZGFormFieldStateValid:
        default:
            self.leftIndicator.layer.contents = (__bridge  id) [UIImage imageNamed:@"lockblue2@2x.png"].CGImage;
