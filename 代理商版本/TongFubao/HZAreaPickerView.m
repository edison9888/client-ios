...
- (void)registerForKeyboardNotifications
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(keyboardWasShownPick:) name:UIKeyboardWillShowNotification object:nil];
    
    [[NSNotificationCenter defaultCenter]  addObserver:self selector:@selector(keyboardWasHiddenPick:) name:UIKeyboardWillHideNotification object:nil];
}

-(void)keyboardWasShownPick:(NSNotification*)noti{
   [self resignFirstResponder];
}

-(void)keyboardWasHiddenPick:(id)noti{
    [self resignFirstResponder];
}
...
- (IBAction)BackCanel:(id)sender {
    ...
    if ([_delegate respondsToSelector:@selector(pickDidCancel:)])
    {
        [_delegate pickDidCancel:self];
    }
