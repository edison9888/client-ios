...
//    [_viewA.layer setValue:@280 forKeyPath:@"frame.origin.y"];
    ...
    self.passwordConfirmField.textField.placeholder = @"请输入您的登录密码";
...
-(void)todomain{
    ...
    if (btn==nil) {
        ...
        btn.frame= CGRectMake(16, 315, 288, 40);
    ...
    [_viewA.layer setValue:@355 forKeyPath:@"frame.origin.y"];
