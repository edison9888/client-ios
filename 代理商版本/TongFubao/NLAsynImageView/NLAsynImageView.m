...
@implementation NLAsynImageView
...
-(void)setImageURL:(NSString *)imageURL
{
    ...
    if(self.imageURL)
    {
        ...
        else
        {
            ...
            if ([UIImage imageWithContentsOfFile:_fileName])
            {
                self.image = [UIImage imageWithContentsOfFile:_fileName];
                //            if ([self.myNLUsersInfoSettingsViewControllerDelegate respondsToSelector:@selector(setDownImage::)])
                {
                    [self.myNLUsersInfoSettingsViewControllerDelegate setDownImage:[UIImage imageWithContentsOfFile:_fileName] pathUrl:self.imageURL];
                }
            }
        }
    }
