...
- (void)viewDidLoad
{
   ...
   */
    IOS7IPHONE4 = IOS7_OR_LATER || IOS7_OR_IPHONE4 == YES? 20 : 64;
...
//iphone4 : 5
-(void)iphone4or5isOnView
{
    _OnBtnClick.frame= CGRectMake(10, 465-IOS7IPHONE4*5/3, 300, 44);
    _LaleHead.frame= CGRectMake(self.LaleHead.frame.origin.x, self.LaleHead.frame.origin.y-IOS7IPHONE4*4/3, self.LaleHead.frame.size.width, self.LaleHead.frame.size.height);
    _LableSide.frame= CGRectMake(self.LableSide.frame.origin.x, self.LableSide.frame.origin.y-IOS7IPHONE4*4/3, self.LableSide.frame.size.width, self.LableSide.frame.size.height);
    _LableBody.frame= CGRectMake(self.LableBody.frame.origin.x, self.LableBody.frame.origin.y-IOS7IPHONE4*4/3, self.LableBody.frame.size.width, self.LableBody.frame.size.height);
    _LableBlue.frame= CGRectMake(self.LableBlue.frame.origin.x, self.LableBlue.frame.origin.y-IOS7IPHONE4*4/3, self.LableBlue.frame.size.width, self.LableBlue.frame.size.height);
    _Lableline.frame= CGRectMake(self.Lableline.frame.origin.x, self.Lableline.frame.origin.y-IOS7IPHONE4*4/3, self.Lableline.frame.size.width, self.Lableline.frame.size.height);
    _LableOnMoney.frame= CGRectMake(self.LableOnMoney.frame.origin.x, self.LableOnMoney.frame.origin.y-IOS7IPHONE4*4/3, self.LableOnMoney.frame.size.width, self.LableOnMoney.frame.size.height);
    _LableIsOkMoney.frame= CGRectMake(self.LableIsOkMoney.frame.origin.x, self.LableIsOkMoney.frame.origin.y-IOS7IPHONE4*4/3, self.LableIsOkMoney.frame.size.width, self.LableIsOkMoney.frame.size.height);
...
- (void)btnIsOnRight
{
    ...
    for (int i=0; i<=5; i++)
    {
        ...
        [btn setFrame:CGRectMake(20, 64 - IOS7IPHONE4 * i + 70, 150, 50)];
...
-(void)SGFocusImageFrame_Action
{
    ...
    imageFrame= [[SGFocusImageFrame alloc] initWithFrame:CGRectMake(0, 64-IOS7IPHONE4, self.view.bounds.size.width, 240.0-IOS7IPHONE4*1/3) delegate:self focusImageItems:item1, nil];
...
-(void)doReadOrderProinfoinfoNotify:(NLProtocolResponse*)response
{
    ...
    else
    {
        ...
        for (int i = 0 ; i < produreid.count; i++)
        {
            ...
            _LableOnMoney.text= [NSString stringWithFormat:@"原价:￥%@元",[array objectAtIndex:0]];
            _LableIsOkMoney.text= [NSString stringWithFormat:@"￥%@",[arrayIsOn objectAtIndex:0]];;
