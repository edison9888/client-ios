...
@interface NLMyBankCardEditViewController : UIViewController<UITextFieldDelegate,NLBankLisDelegate,/*VisaReaderDelegate,*/UITableViewDataSource,UITableViewDelegate>
