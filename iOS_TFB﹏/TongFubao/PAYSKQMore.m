...
-(void)someViewTableScrollerView{
    ...
    _myTableView.frame= CGRectMake(0, 0-IOS7HEIGHT*1/8, 320, 160);
    ...
    if (ios7Height==568) {
         ...
         self.ScrollerView.frame= CGRectMake(self.ScrollerView.frame.origin.x, 0, 320, 568);
        ...
        self.ScrollerView.frame= CGRectMake(self.ScrollerView.frame.origin.x, 0, 320, self.view.frame.size.height);
