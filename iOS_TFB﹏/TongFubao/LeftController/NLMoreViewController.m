...
{
    NSString *phone= [NLUtils getRegisterMobile];
    
           switch (indexPath.row)
        {
            case 0:
            {
                cell.myHeaderLabel.text = @"账户注销";
                ...
                cell.myContentLabel.text = phone;
            }
                break;
...
- (void)doCellForSection0:(NSIndexPath *)indexPath
{
    switch (indexPath.row)
    {
        case 0:
        {
            ...
            {
                [NLUtils showAlertView:@"确认登出当前账号?"
                               message:nil
                              delegate:self
                                   tag:0
                             cancelBtn:@"取消"
        ...
        case 1:
        {
            ...
            {
                NLPassWordManagerViewController* vc = (NLPassWordManagerViewController*)[[NLPushViewIntoNav sharePushViewIntoNav] getPushViewIntoNavByType:NLPushViewType_PassWordManager];
                vc.myBackToLogon = NO;
        ...
        case 3:
        {
            ...
            {
                UIViewController* vc = [[NLPushViewIntoNav sharePushViewIntoNav] getPushViewIntoNavByType:NLPushViewType_MyBankCard];
                [self.navigationController pushViewController:vc animated:YES];
            }
        }
            break;
