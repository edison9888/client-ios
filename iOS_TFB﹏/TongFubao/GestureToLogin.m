...
- (void)viewDidLoad
{
   ...
   IOS7IPHONE4=IOS7_OR_LATER==YES?0:64;
    ...
    self.infoLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 50-IOS7IPHONE4/1.6, 300, 30)];
    ...
    for (int i=0; i<9; i++) {
        UIImageView *singleImg = [[UIImageView alloc]initWithFrame:CGRectMake(125+12*(i%3), 92+12*(i/3)-IOS7IPHONE4/1.3, 9.5, 9.5)];
        singleImg.tag = i;
...
- (void)updateInfoLabel
{
    ...
    switch (self.state)
    {
        ...
        case ePasswordRepeat:
            ...
            infoText = [NSString stringWithFormat:@"请再次绘制您刚才的手势密码"];
        ...
        case ePasswordExist:{
            //路径
        [self recordBt];
        infoText = [NSString stringWithFormat:@"请您再次绘制您刚才的手势密码"];
