...
- (id)initWithYearStart:(NSUInteger)start end:(NSUInteger)end {
    ...
    if (self) {
        ...
        self.weekdays=@[NSLocalizedString(@"Sunday", nil),NSLocalizedString(@"Monday", nil),NSLocalizedString(@"Tuesday", nil),NSLocalizedString(@"Wednesday", nil),NSLocalizedString(@"Thursday", nil),NSLocalizedString(@"Friday", nil),NSLocalizedString(@"Saturday", nil),];
//        "Sunday"="Sunday";
//        "Monday"="Monday";
//        "Tuesday"="Tuesday";
//        "Wednesday"="Wednesday";
