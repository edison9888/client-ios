...
#define Q_RADIO_ICON_WH                     (80.0)
#define Q_ICON_TITLE_MARGIN                 (41.0)
...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"btnBack"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"backColor2"] forState:UIControlStateSelected];
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect {
    return CGRectMake(0, (CGRectGetHeight(contentRect) - Q_RADIO_ICON_WH)/2.0, Q_RADIO_ICON_WH, Q_ICON_TITLE_MARGIN);
}

- (CGRect)titleRectForContentRect:(CGRect)contentRect {
    return CGRectMake(22,(CGRectGetHeight(contentRect) - Q_RADIO_ICON_WH)/2.0,
                      Q_RADIO_ICON_WH,
                      Q_ICON_TITLE_MARGIN);
}
