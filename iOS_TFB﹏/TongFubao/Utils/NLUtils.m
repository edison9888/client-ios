...
//    if (IOS_7)
//    {
//        [backButton setBackgroundImage:[UIImage imageNamed:@"navigationLeftBtnBack2@2x.png"] forState:UIControlStateNormal];
//    }
//    else
    {
...
//{
//    NSString* match = @"^[1][358][0-9]{9}$";
//    return [NLUtils matchRegularExpression:number match:match];
//}
...
+(void)popToTheLogonVCFromMore:(UINavigationController*)nav
{
    for (UIViewController *controller in nav.viewControllers)
    {
        ...
        {
            //[[(NLMoreViewController*)controller myTableView] reloadData];
...
+(BOOL)checkMobilePhone:(NSString*) mobilePhone
{
    ...
    NSArray* mobilePhoneStarts = [NSArray arrayWithObjects:@"106|移动", @"130|联通", @"131|联通", @"132|联通", @"133|电信", @"134|移动", @"135|移动", @"136|移动", @"137|移动", @"138|移动", @"139|移动",@"145|联通", @"147|移动", @"150|移动", @"152|移动", @"153|电信", @"155|联通", @"156|联通", @"157|移动", @"158|移动", @"159|移动",@"180|电信", @"181|电信", @"182|移动", @"183|移动",@"184|移动", @"185|联通", @"186|联通", @"187|移动", @"188|移动", @"189|电信",@"151|移动", nil];
...
//    NSString* mach = @"^[\u4e00-\u9fa5]([\u4e00-\u9fa5]|[a-zA-Z]){1,6}$";
...
+(NSString*)get_req_token
{
    ...
    {
    NSLog(@"加密前req_token%@",g_req_token);
       g_req_token = [NLUtils create_req_token];//加密数据
    }
    NSLog(@"加密后req_token%@",g_req_token);
    return g_req_token;
}
