...
-(NSMutableArray*)doCreditCardPaymentsDetail:(int)index
{
    ...
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"手续费",@"header", [dictionary objectForKey:@"feemoney"],@"content", nil];
    [arr addObject:dic];
    
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"交易金额",@"header", [dictionary objectForKey:@"allmoney"],@"content", nil];
    [arr addObject:dic];
...
-(NSMutableArray*)doTransferMoneyDetail:(int)index
{
    ...
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"转账金额",@"header", [dictionary objectForKey:@"paymoney"],@"content", nil];
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"手续费",@"header", [dictionary objectForKey:@"feemoney"],@"content", nil];
    [arr addObject:dic];
...
-(NSMutableArray*)doCashArriveDetail:(int)index
{
    ...
    [arr addObject:dic];
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"交易金额",@"header", [dictionary objectForKey:@"couponmoney"],@"content", nil];
    [arr addObject:dic];
...
-(NSMutableArray*)doReturnLoanDetail:(int)index
{
    ...
    dic = [NSDictionary dictionaryWithObjectsAndKeys:@"还贷金额",@"header", [dictionary objectForKey:@"paymoney"],@"content", nil];
    [arr addObject:dic];
